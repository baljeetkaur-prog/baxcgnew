...
const Contactus = () => {
  ...
  const openCalendly = () => {
    window.open('https://outlook.office.com/book/BookwithBax@NETORG18291625.onmicrosoft.com/?ismsaljsauthenabled', '_blank');
  };
  ...
  loop
  playsInline
  poster="/images/corporateeditoverlay.png" 
>
    ...
    <div className="row">
        ...
        <div className="contact-address p-4 mt-4" data-aos="fade-right" data-aos-delay="200">
          <div className="contact-icon d-flex align-items-center">
            ...
            <div className="ms-3">
              ...
              <a href="mailto:bax@baxcg.com">info@baxcg.com</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .read-more-link {
          ...
          [data-theme="dark"] .map-contact iframe {
