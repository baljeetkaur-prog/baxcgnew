...
const Servicedetail = () => {
  ...
  loop
  playsInline
  poster="/images/video2overlay.png"  
>
      ...
      <div className="col-lg-8" data-aos="fade-up" data-aos-duration="1000">
        ...
        >
          <div className="d-flex align-items-center mb-4">
           ...
           <h3 className="mb-0 fw-bold text-break" style={{ fontSize: '1.5rem' }}>{service.title}</h3>
...
/>
        ...
        <div className="container py-md-5 py-sm-4 py-2">
          <div className="row py-4">
            <div className="col-lg-7">
              ...
              <button
                onClick={() => window.open('https://outlook.office.com/book/BookwithBax@NETORG18291625.onmicrosoft.com/?ismsaljsauthenabled', '_blank')}
  ...
  /* ✅ Responsive content only - video unchanged */
  @media (max-width: 768px) {
    .inner-text-title {
      font-size: 1.3rem !important;
    }
