...
>
  ...
  >
    <i className={`${service.icon} fa-sm text-dark`}></i>
  </div>

  {/* Numbering */}
  <h6
    className="number fw-bold mb-1"
    style={{
      fontSize: '1.6rem',
    color: isDark ? '#222' : '#a6a6a6',
      marginBottom: '0.5rem',
    }}
  >
    {service.number}
  ...
  <h4
    ...
    style={{ fontSize: '1.25rem', marginTop: '-0.3rem' }}
  >
    <Link
      to={`/servicedetail/${service.id}`}
  ...
  {/* Description */}
  <p className="mb-3" style={{ color: '#444', fontSize: '1rem', marginTop: '-0.3rem' }}>
    {service.desc}
  </p>
