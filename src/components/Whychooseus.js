...
const Whychooseus = () => {
  return (
    <section className="w3l-servicesblock py-5" id="whychoose">
      {/* Full width container without Bootstrap’s default padding */}
      <div className="container-fluid px-2 px-sm-3 px-md-5 py-lg-5 py-md-4 py-2">
        <div className="row g-0 align-items-center">
          {/* Full Width Content */}
          <div className="col-12 text-justify" data-aos="fade-right">
            ...
            <div className="row two-grids mt-5 pt-lg-4 g-3">
              ...
              <div className="col-sm-6 grids_info d-flex" data-aos="fade-up" data-aos-delay="200">
